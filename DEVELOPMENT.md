...
```bash
git remote add encore encore://shj-jewelry-database-go7i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/shj-jewelry-database-go7i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/shj-jewelry-database-go7i/settings/integrations/github)
